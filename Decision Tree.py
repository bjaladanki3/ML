...
params = {'DT__criterion':['gini','entropy'],'DT__alpha':alphas,'DT__class_weight':['balanced']}
spam_clf = basicResults(pipeB,spam_trgX,spam_trgY,spam_tstX,spam_tstY,params,'DT','spam')

spam_final_params = spam_clf.best_params_
pipeB.set_params(**spam_final_params)
makeTimingCurve(spamX,spamY,pipeB,'DT','spam')
DTpruningVSnodes(pipeB,alphas,spam_trgX,spam_trgY,'spam')
