...
spam_clf = basicResults(pipeB,spam_trgX,spam_trgY,spam_tstX,spam_tstY,paramsB,'Boost','spam')
...
makeTimingCurve(spamX,spamY,pipeB,'Boost','spam')
pipeB.set_params(**spam_final_params)
iterationLC(pipeB,spam_trgX,spam_trgY,spam_tstX,spam_tstY,{'Boost__n_estimators':[1,2,5,10,20,30,40,50]},'Boost','spam')

pipeB.set_params(**OF_params)
iterationLC(pipeB,spam_trgX,spam_trgY,spam_tstX,spam_tstY,{'Boost__n_estimators':[1,2,5,10,20,30,40,50]},'Boost_OF','spam')
